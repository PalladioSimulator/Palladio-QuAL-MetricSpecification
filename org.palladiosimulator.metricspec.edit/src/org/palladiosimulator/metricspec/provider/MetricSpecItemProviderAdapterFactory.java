...
public class MetricSpecItemProviderAdapterFactory extends MetricSpecAdapterFactory implements
    ...
    public void dispose() {
        ...
        if (textualBaseMetricDescriptionItemProvider != null)
            textualBaseMetricDescriptionItemProvider.dispose();
        if (aggregationFunctionDescriptionItemProvider != null)
            aggregationFunctionDescriptionItemProvider.dispose();
        if (metricSetDescriptionItemProvider != null)
            metricSetDescriptionItemProvider.dispose();
        if (numericalBaseMetricDescriptionItemProvider != null)
            numericalBaseMetricDescriptionItemProvider.dispose();
        if (metricDescriptionRepositoryItemProvider != null)
            metricDescriptionRepositoryItemProvider.dispose();
    }
