...
/**
 * <!-- begin-user-doc --> 
 *   A builder for the model object '<em><b>org.palladiosimulator.metricspec.TextualBaseMetricDescription</b></em>'.
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class TextualBaseMetricDescriptionBuilder implements org.palladiosimulator.metricspec.util.builder.IMetricspecBuilder<org.palladiosimulator.metricspec.TextualBaseMetricDescription> {
  ...
  /**
   * This method creates a new instance of the TextualBaseMetricDescriptionBuilder. 
   * The builder is initialized using an existing '<em><b>org.palladiosimulator.metricspec.TextualBaseMetricDescription</b></em>' model object.
   * In order to avoid changes to the provided '<em><b>org.palladiosimulator.metricspec.TextualBaseMetricDescription</b></em>' model object, a copy is created using <em><b>org.eclipse.emf.ecore.util.EcoreUtil.Copier</b></em>.
   * @param textualBaseMetricDescription The existing '<em><b>org.palladiosimulator.metricspec.TextualBaseMetricDescription</b></em>' model object to be used for the initialization of the builder  
   * @return new initialized instance of the TextualBaseMetricDescriptionBuilder
   */
  public static TextualBaseMetricDescriptionBuilder newTextualBaseMetricDescriptionBuilder(org.palladiosimulator.metricspec.TextualBaseMetricDescription p_textualBaseMetricDescription) {
   ...
   * @return new instance of the org.palladiosimulator.metricspec.TextualBaseMetricDescription type
   */
  ...
  public TextualBaseMetricDescriptionBuilder repository(org.palladiosimulator.metricspec.MetricDescriptionRepository p_repository) {
  ...
  public TextualBaseMetricDescriptionBuilder identifiers(java.util.Collection<? extends org.palladiosimulator.metricspec.Identifier> p_identifiers) {
    m_identifiers.addAll(p_identifiers);
    m_featureIdentifiersSet = true;
    return this;
  }

  public TextualBaseMetricDescriptionBuilder identifiers(org.palladiosimulator.metricspec.util.builder.IMetricspecBuilder<? extends org.palladiosimulator.metricspec.Identifier> p_identifierBuilder) {
