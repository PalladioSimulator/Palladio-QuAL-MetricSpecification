...
/**
 * <!-- begin-user-doc --> 
 *   A builder for the model object '<em><b>org.palladiosimulator.metricspec.AggregationFunctionDescription</b></em>'.
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class AggregationFunctionDescriptionBuilder implements org.palladiosimulator.metricspec.util.builder.IMetricspecBuilder<org.palladiosimulator.metricspec.AggregationFunctionDescription> {
  ...
  /**
   * This method creates a new instance of the AggregationFunctionDescriptionBuilder. 
   * The builder is initialized using an existing '<em><b>org.palladiosimulator.metricspec.AggregationFunctionDescription</b></em>' model object.
   * In order to avoid changes to the provided '<em><b>org.palladiosimulator.metricspec.AggregationFunctionDescription</b></em>' model object, a copy is created using <em><b>org.eclipse.emf.ecore.util.EcoreUtil.Copier</b></em>.
   * @param aggregationFunctionDescription The existing '<em><b>org.palladiosimulator.metricspec.AggregationFunctionDescription</b></em>' model object to be used for the initialization of the builder  
   * @return new initialized instance of the AggregationFunctionDescriptionBuilder
   */
  public static AggregationFunctionDescriptionBuilder newAggregationFunctionDescriptionBuilder(org.palladiosimulator.metricspec.AggregationFunctionDescription p_aggregationFunctionDescription) {
   ...
   * @return new instance of the org.palladiosimulator.metricspec.AggregationFunctionDescription type
   */
  public org.palladiosimulator.metricspec.AggregationFunctionDescription build() {
    final org.palladiosimulator.metricspec.AggregationFunctionDescription _newInstance = (org.palladiosimulator.metricspec.AggregationFunctionDescription) org.palladiosimulator.metricspec.MetricSpecFactory.eINSTANCE
        .create(org.palladiosimulator.metricspec.MetricSpecPackage.eINSTANCE.getAggregationFunctionDescription());
    if (m_featureIdSet) {
