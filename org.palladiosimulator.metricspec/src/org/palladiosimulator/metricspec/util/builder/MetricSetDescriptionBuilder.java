...
/**
 * <!-- begin-user-doc --> 
 *   A builder for the model object '<em><b>org.palladiosimulator.metricspec.MetricSetDescription</b></em>'.
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class MetricSetDescriptionBuilder implements org.palladiosimulator.metricspec.util.builder.IMetricspecBuilder<org.palladiosimulator.metricspec.MetricSetDescription> {
  ...
  /**
   * This method creates a new instance of the MetricSetDescriptionBuilder. 
   * The builder is initialized using an existing '<em><b>org.palladiosimulator.metricspec.MetricSetDescription</b></em>' model object.
   * In order to avoid changes to the provided '<em><b>org.palladiosimulator.metricspec.MetricSetDescription</b></em>' model object, a copy is created using <em><b>org.eclipse.emf.ecore.util.EcoreUtil.Copier</b></em>.
   * @param metricSetDescription The existing '<em><b>org.palladiosimulator.metricspec.MetricSetDescription</b></em>' model object to be used for the initialization of the builder  
   * @return new initialized instance of the MetricSetDescriptionBuilder
   */
  public static MetricSetDescriptionBuilder newMetricSetDescriptionBuilder(org.palladiosimulator.metricspec.MetricSetDescription p_metricSetDescription) {
  ...
  public MetricSetDescriptionBuilder repository(org.palladiosimulator.metricspec.MetricDescriptionRepository p_repository) {
  ...
  public MetricSetDescriptionBuilder subsumedMetrics(org.palladiosimulator.metricspec.MetricDescription p_subsumedMetrics) {
    m_subsumedMetrics.add(p_subsumedMetrics);
    m_featureSubsumedMetricsSet = true;
    return this;
  }

  public MetricSetDescriptionBuilder subsumedMetrics(java.util.Collection<? extends org.palladiosimulator.metricspec.MetricDescription> p_subsumedMetrics) {
