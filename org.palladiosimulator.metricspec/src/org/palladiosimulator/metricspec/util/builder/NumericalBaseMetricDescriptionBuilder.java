...
/**
 * <!-- begin-user-doc --> 
 *   A builder for the model object '<em><b>org.palladiosimulator.metricspec.NumericalBaseMetricDescription</b></em>'.
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class NumericalBaseMetricDescriptionBuilder implements org.palladiosimulator.metricspec.util.builder.IMetricspecBuilder<org.palladiosimulator.metricspec.NumericalBaseMetricDescription> {
  ...
  /**
   * This method creates a new instance of the NumericalBaseMetricDescriptionBuilder. 
   * The builder is initialized using an existing '<em><b>org.palladiosimulator.metricspec.NumericalBaseMetricDescription</b></em>' model object.
   * In order to avoid changes to the provided '<em><b>org.palladiosimulator.metricspec.NumericalBaseMetricDescription</b></em>' model object, a copy is created using <em><b>org.eclipse.emf.ecore.util.EcoreUtil.Copier</b></em>.
   * @param numericalBaseMetricDescription The existing '<em><b>org.palladiosimulator.metricspec.NumericalBaseMetricDescription</b></em>' model object to be used for the initialization of the builder  
   * @return new initialized instance of the NumericalBaseMetricDescriptionBuilder
   */
  public static NumericalBaseMetricDescriptionBuilder newNumericalBaseMetricDescriptionBuilder(org.palladiosimulator.metricspec.NumericalBaseMetricDescription p_numericalBaseMetricDescription) {
   ...
   * @return new instance of the org.palladiosimulator.metricspec.NumericalBaseMetricDescription type
   */
  public org.palladiosimulator.metricspec.NumericalBaseMetricDescription build() {
    final org.palladiosimulator.metricspec.NumericalBaseMetricDescription _newInstance = (org.palladiosimulator.metricspec.NumericalBaseMetricDescription) org.palladiosimulator.metricspec.MetricSpecFactory.eINSTANCE
        .create(org.palladiosimulator.metricspec.MetricSpecPackage.eINSTANCE.getNumericalBaseMetricDescription());
  ...
  public NumericalBaseMetricDescriptionBuilder persistenceKind(org.palladiosimulator.metricspec.PersistenceKindOptions p_persistenceKind) {
    m_persistenceKind = p_persistenceKind;
    m_featurePersistenceKindSet = true;
    return this;
  }

  public NumericalBaseMetricDescriptionBuilder repository(org.palladiosimulator.metricspec.MetricDescriptionRepository p_repository) {
