...
/**
 * <!-- begin-user-doc --> 
 *   A builder for the model object '<em><b>org.palladiosimulator.metricspec.Identifier</b></em>'.
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class IdentifierBuilder implements org.palladiosimulator.metricspec.util.builder.IMetricspecBuilder<org.palladiosimulator.metricspec.Identifier> {
  ...
  /**
   * This method creates a new instance of the IdentifierBuilder. 
   * The builder is initialized using an existing '<em><b>org.palladiosimulator.metricspec.Identifier</b></em>' model object.
   * In order to avoid changes to the provided '<em><b>org.palladiosimulator.metricspec.Identifier</b></em>' model object, a copy is created using <em><b>org.eclipse.emf.ecore.util.EcoreUtil.Copier</b></em>.
   * @param identifier The existing '<em><b>org.palladiosimulator.metricspec.Identifier</b></em>' model object to be used for the initialization of the builder  
  ...
  public static IdentifierBuilder newIdentifierBuilder(org.palladiosimulator.metricspec.Identifier p_identifier) {
    ...
    org.palladiosimulator.metricspec.Identifier _identifier = (org.palladiosimulator.metricspec.Identifier) c.copy(((org.palladiosimulator.metricspec.Identifier) p_identifier));
    c.copyReferences();
  ...
  public IdentifierBuilder textualBaseMetricDescription(org.palladiosimulator.metricspec.TextualBaseMetricDescription p_textualBaseMetricDescription) {
