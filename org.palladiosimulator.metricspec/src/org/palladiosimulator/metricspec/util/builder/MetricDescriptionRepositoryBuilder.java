...
/**
 * <!-- begin-user-doc --> 
 *   A builder for the model object '<em><b>org.palladiosimulator.metricspec.MetricDescriptionRepository</b></em>'.
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class MetricDescriptionRepositoryBuilder implements org.palladiosimulator.metricspec.util.builder.IMetricspecBuilder<org.palladiosimulator.metricspec.MetricDescriptionRepository> {
  ...
  /**
   * This method creates a new instance of the MetricDescriptionRepositoryBuilder. 
   * The builder is initialized using an existing '<em><b>org.palladiosimulator.metricspec.MetricDescriptionRepository</b></em>' model object.
   * In order to avoid changes to the provided '<em><b>org.palladiosimulator.metricspec.MetricDescriptionRepository</b></em>' model object, a copy is created using <em><b>org.eclipse.emf.ecore.util.EcoreUtil.Copier</b></em>.
   * @param metricDescriptionRepository The existing '<em><b>org.palladiosimulator.metricspec.MetricDescriptionRepository</b></em>' model object to be used for the initialization of the builder  
   * @return new initialized instance of the MetricDescriptionRepositoryBuilder
   */
  public static MetricDescriptionRepositoryBuilder newMetricDescriptionRepositoryBuilder(org.palladiosimulator.metricspec.MetricDescriptionRepository p_metricDescriptionRepository) {
  ...
  public MetricDescriptionRepositoryBuilder metricDescriptions(org.palladiosimulator.metricspec.MetricDescription p_metricDescriptions) {
    m_metricDescriptions.add(p_metricDescriptions);
    m_featureMetricDescriptionsSet = true;
    return this;
  }

  public MetricDescriptionRepositoryBuilder metricDescriptions(java.util.Collection<? extends org.palladiosimulator.metricspec.MetricDescription> p_metricDescriptions) {
