 ...
 *   <li>{@link org.palladiosimulator.metricspec.impl.DescriptionImpl#getTextualDescription <em>Textual Description</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class DescriptionImpl extends IdentifierImpl implements Description {
    ...
    public void setTextualDescription(String newTextualDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetricSpecPackage.DESCRIPTION__TEXTUAL_DESCRIPTION, oldTextualDescription, textualDescription));
	}
